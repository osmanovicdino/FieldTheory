...
int main(int argc, char **argv)
{
    ...
    // string import1 = "/home/dino/Documents/Chemistry/Invasion/Resubmission/DataGood/
    // field0original=0.1_densi=1_eps1=0_D2=10_i=";
    // stringstream ss;
    ...
    cout << "all input parameters" << endl;
    cout << c0 << endl;
    cout << c1 << endl;
    cout << eps << endl;
    cout << densi << endl;
    ...
    for (int i = 0; i < runtime; i++)
    {
        ...
        if (i % every == 0)
        {
            ...
            string s1 = "original=" + strep1.str() + "_densi=" + strep2.str() + "_D2=" + strep4.str();
            stringstream ss;
