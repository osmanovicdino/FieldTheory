...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < nof; i++)
    {
        ...
        {
            // cout << i << " " << j << endl;
            a.epsilon_couplingsSQR(i, j) =epsa(i,j);

            a.epsilon_couplingsSQR(j, i) = epsa(i, j);
        }
    }
    ...
    a.set_dt(0.01*phasesepsparams[6]);
