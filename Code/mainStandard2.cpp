...
int main(int argc, char **argv)
{
    ...
    NoWeight<myc,myc> nw; // the solvent;
    // double rate2 = 0.192;
    // double rate1 = 0.712;
    ...
    InvasionLinear<myc> c6_3(-2*kr1,1,3);
    InvasionSquared<myc> c6_4(-kr2,3,2);
    ...
    MultipleReactions<myc> c7(4);
    InvasionSquared<myc> c7_1(2* kf2, 1, 0);
    InvasionSquared<myc> c7_2(-kf1, 0, 3);
    InvasionLinear<myc> c7_3(kr1, 1, 3);
    InvasionSquared<myc> c7_4(- 2 *kr2, 3, 2);

    c7.add_chemical_reaction(c7_1, 0);
    c7.add_chemical_reaction(c7_2, 1);
    c7.add_chemical_reaction(c7_3, 2);
    c7.add_chemical_reaction(c7_4, 3);

    my_chemsitry.add_method(c7, 1);

    MultipleReactions<myc> c8(2);
    InvasionSquared<myc> c8_1(-kf2, 1, 0);
    InvasionSquared<myc> c8_4( kr2, 3, 2);

    c8.add_chemical_reaction(c8_1, 0);
    c8.add_chemical_reaction(c8_4, 1);

    my_chemsitry.add_method(c8, 2);

    MultipleReactions<myc> c9(2);
    InvasionSquared<myc> c9_1(-2*kf2, 1, 0);
    InvasionSquared<myc> c9_4(2*kr2, 3, 2);
    ...
    double nu = 1.0;
    double epsilon12 = 0.145229;
    double epsilon13 = 0.48;
    double epsilon14 = 0.49;
