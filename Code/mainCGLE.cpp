...
int main(int argc, char **argv)
{
    ...
    */
    ...
    for (int i1 = 0; i1 < N1; i1++)
    {
        ...
        {
            int indx =i1 * N2 + j;
            res(i1, j) = upd1[indx] * (1.+deltat)*transformed1.calculated_reactions[0][indx] - (upd1[indx]) *deltat * fac2*  transformed1.calculated_reactions[1][indx];
