...
ftdir="WavesChemistryRepeat13"
mkdir /u/scratch/d/dinoo/${ftdir}/${dirwemake}
cp ~/FieldTheory/Code/mainFractionalDiffusionNormalChemFlat1D.cpp /u/scratch/d/dinoo/${ftdir}/${dirwemake}
cp ~/FieldTheory/Code/InitialConditions/Cond15/${wt} /u/scratch/d/dinoo/${ftdir}/${dirwemake}/res.csv
g++ ~/FieldTheory/Code/mainFractionalDiffusionNormalChemFlat1D.cpp -lm -lfftw3 -L/usr/local/lib/lfftw3.a -std=c++17 -o /u/scratch/d/dinoo/${ftdir}/${dirwemake}/angron
