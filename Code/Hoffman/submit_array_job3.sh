...
cp ~/FieldTheory/Code/mainFractionalDiffusionNormalChemSQR.cpp /u/scratch/d/dinoo/${ftdir}/${dirwemake}
cp ~/FieldTheory/Code/InitialConditions/${wt} /u/scratch/d/dinoo/${ftdir}/${dirwemake}/res.csv
g++ ~/FieldTheory/Code/mainFractionalDiffusionNormalChemSQR.cpp -lm -lfftw3 -L/usr/local/lib/lfftw3.a -std=c++17 -o /u/scratch/d/dinoo/${ftdir}/${dirwemake}/angron
