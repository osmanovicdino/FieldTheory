...
int main(int argc, char **argv)
{
    ...
    double nuc = 2.77778;
    a.set_diffusion(phasesepsparams[0], 0);
    a.set_epsilon(phasesepsparams[1], 0);
    a.set_c0_c1(phasesepsparams[2], phasesepsparams[3], 0, nuc);

    nuc = 5.9;
    a.set_diffusion(phasesepsparams[0], 1);
    a.set_epsilon(phasesepsparams[1], 1);
    a.set_c0_c1(phasesepsparams[2], phasesepsparams[3], 1, nuc);
    ...
    a.calculate_initial_weight(512);
