...
#include "../DataStructures/LogSpace.h"
...
double determine_stepsize2(matrix<double> &x, matrix<double> &a, double param, double fe1); //determine stepsize for annealed copolymer

double determine_stepsize2_copolymer(matrix<double> &x, matrix<double> &a, double param, double fe1); //determine stepsize for annealed copolymer with fixed bookmarks

double determine_stepsize2_dcopolymer(matrix<double> &x, matrix<double> &a, double param, double fe1); //determine stepsize for copolymer with both regions annealed


double freeenergy(matrix<double> &field); //free energy for an annealed copolymer

double freeenergy_copolymer(vector1<double>&, matrix<double>&); //free energy for an annealed copolymer

double freeenergy_dcopolymer(matrix<double>&, matrix<double>&);

double freeenergy_copolymer(matrix<double>&,bool);

double freeenergy_dcopolymer(matrix<double>&,bool);

double freeenergy(matrix<double>&, matrix<double>&, double &);

double freeenergy_copolymer(matrix<double>&, matrix<double>&, double&);

double freeenergy_dcopolymer(matrix<double>&, matrix<double>&, double&);

double freeenergy_copolymer(matrix<double>&, vector1<double>&, matrix<double>&, double&);

double freeenergy_dcopolymer(matrix<double>&, matrix<double>&, matrix<double>&, double&);
...
matrix<double> densityfromfield_dcopolymer(matrix<double>&);

matrix<double> densityfromfield_copolymer(vector1<double>&,matrix<double>&,double&);

matrix<double> densityfromfield_dcopolymer(matrix<double>&,matrix<double>&,double&);
...
matrix<double> genconvolocal_dcopolymer(matrix<double>&);
...
void iteratefield_dcopolymer(matrix<double> &field, double dt, double &fen, double&);
...
void run_dcopolymer(matrix<double> &mf, int tot, double dt);
